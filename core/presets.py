...
VIEW_PRESETS: dict[str, ViewConfig] = {
    ...
    "high": ViewConfig(
        views=[
            FreeView("00_00", yaw=0.0, pitch=90.0, fov=90),
            FreeView("00_01", yaw=137.51, pitch=63.47, fov=90),
            FreeView("00_02", yaw=-84.98, pitch=52.14, fov=90),
            FreeView("00_03", yaw=52.52, pitch=43.17, fov=90),
            FreeView("00_04", yaw=-169.97, pitch=35.38, fov=90),
            FreeView("00_05", yaw=-32.46, pitch=28.27, fov=90),
            FreeView("00_06", yaw=105.05, pitch=21.62, fov=90),
            FreeView("00_07", yaw=-117.45, pitch=15.26, fov=90),
            FreeView("00_08", yaw=20.06, pitch=9.08, fov=90),
            FreeView("00_09", yaw=157.57, pitch=3.02, fov=90),
            FreeView("00_10", yaw=-64.92, pitch=-3.02, fov=90),
            FreeView("00_11", yaw=72.59, pitch=-9.08, fov=90),
            FreeView("00_12", yaw=-149.91, pitch=-15.26, fov=90),
            FreeView("00_13", yaw=-12.4, pitch=-21.62, fov=90),
            FreeView("00_14", yaw=125.11, pitch=-28.27, fov=90),
            FreeView("00_15", yaw=-97.38, pitch=-35.38, fov=90),
            FreeView("00_16", yaw=40.12, pitch=-43.17, fov=90),
            FreeView("00_17", yaw=177.63, pitch=-52.14, fov=90),
            FreeView("00_18", yaw=-44.86, pitch=-63.47, fov=90),
            FreeView("00_19", yaw=180.0, pitch=-90.0, fov=90),
        ],
        include_zenith=False,
        include_nadir=False,
    ),
    "ultra": ViewConfig(
        views=[
            FreeView("00_00", yaw=0.0, pitch=90.0, fov=90),
            FreeView("00_01", yaw=137.51, pitch=65.93, fov=90),
            FreeView("00_02", yaw=-84.98, pitch=55.7, fov=90),
            FreeView("00_03", yaw=52.52, pitch=47.66, fov=90),
            FreeView("00_04", yaw=-169.97, pitch=40.71, fov=90),
            FreeView("00_05", yaw=-32.46, pitch=34.42, fov=90),
            FreeView("00_06", yaw=105.05, pitch=28.57, fov=90),
            FreeView("00_07", yaw=-117.45, pitch=23.04, fov=90),
            FreeView("00_08", yaw=20.06, pitch=17.72, fov=90),
            FreeView("00_09", yaw=157.57, pitch=12.56, fov=90),
            FreeView("00_10", yaw=-64.92, pitch=7.49, fov=90),
            FreeView("00_11", yaw=72.59, pitch=2.49, fov=90),
            FreeView("00_12", yaw=-149.91, pitch=-2.49, fov=90),
            FreeView("00_13", yaw=-12.4, pitch=-7.49, fov=90),
            FreeView("00_14", yaw=125.11, pitch=-12.56, fov=90),
            FreeView("00_15", yaw=-97.38, pitch=-17.72, fov=90),
            FreeView("00_16", yaw=40.12, pitch=-23.04, fov=90),
            FreeView("00_17", yaw=177.63, pitch=-28.57, fov=90),
            FreeView("00_18", yaw=-44.86, pitch=-34.42, fov=90),
            FreeView("00_19", yaw=92.65, pitch=-40.71, fov=90),
            FreeView("00_20", yaw=-129.84, pitch=-47.66, fov=90),
            FreeView("00_21", yaw=7.66, pitch=-55.7, fov=90),
            FreeView("00_22", yaw=145.17, pitch=-65.93, fov=90),
            FreeView("00_23", yaw=0.0, pitch=-90.0, fov=90),
        ],
        include_zenith=False,
        include_nadir=False,
    ),
